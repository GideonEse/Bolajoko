...
/**
 * @fileOverview Verifies receipt authenticity based on receipt ID, stamp, signature, and date.
 *
...
const VerifyReceiptInputSchema = z.object({
  ...
  stamp: z.string().describe('Description of the stamp on the receipt.'),
  signature: z.string().describe('Description of the signature on the receipt.'),
